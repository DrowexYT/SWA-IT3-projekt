...
if (isset($_POST['action'])) {
    ...
    switch ($action) {
        ...
        case 'make_admin':
            ...
            break;
        case 'make_user':
            $mysqli->query("UPDATE users SET role = 'user' WHERE id = $user_id");
            break;
    }
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <?php if ($row['role'] !== 'admin'): ?>
                                    <form method="post" style="display: inline;">
                                        <input type="hidden" name="user_id" value="<?php echo $row['id']; ?>">
                                        <button type="submit" name="action" value="make_admin" class="edit-btn">Udělat Admin</button>
                                    </form>
                                <?php else: ?>
                                    <form method="post" style="display: inline;">
                                        <input type="hidden" name="user_id" value="<?php echo $row['id']; ?>">
                                        <button type="submit" name="action" value="make_user" class="edit-btn">Udělat Uživatele</button>
                                    </form>
                                <?php endif; ?>
                            </td>
                        </tr>
